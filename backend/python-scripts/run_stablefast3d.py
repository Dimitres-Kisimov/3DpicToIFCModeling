"""
StableFast3D inference script - balanced depth-based 3D mesh from a single image.
Uses DPT depth estimation at medium resolution.
"""
...
def generate_mesh_stablefast3d(image_path, output_path):
    try:
        log("StableFast3D: balanced depth-based mesh generation", "info")
